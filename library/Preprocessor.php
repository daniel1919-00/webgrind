...
class Preprocessor
{
     ...
     * @throws Exception
     */
    static function parse(string $inFile, string $outFile): void
    {
        ...
        $proxyFunctions = array_flip(Config::$proxyFunctions);
        $proxyQueue = array();
        $nextFuncNr = 0;
        $functionNames = array();
        $functions = array();
        ...
        while (($line = fgets($in)))
        {
            ...
            } else if (str_starts_with($line, 'cfn='))
            {
     ...
     * @param bool $isFile True if this is a filename line (since files and functions have their own symbol tables)
     * @return string
     **/
    static function getCompressedName(string $name, bool $isFile): string
    {
     ...
     */
    static function binaryParse(string $inFile, string $outFile): bool
    {
        $preprocessor = Config::getBinaryPreprocessor();
        ...
        foreach (Config::$proxyFunctions as $function)
        {
