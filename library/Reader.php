...
class Reader
{
     ...
     * @throws Exception
     */
    function __construct(string $dataFile, string $costFormat)
    {
        $this->filePointer = @fopen($dataFile, 'rb');
        if (!$this->filePointer)
            throw new Exception('Error opening file: ' . $dataFile);
    ...
    {
        return fseek($this->filePointer, $offset, $whence);
    }
