...
use Webgrind\library\MasterConfig;
 ...
 */
class Config extends MasterConfig
{
     ...
     * Writable dir for information storage
     */
    static function storageDir(): string
    {
        if (!empty(Config::$storageDir))
        {
            return realpath(Config::$storageDir) . '/';
        }

        if (!function_exists('sys_get_temp_dir') || !is_writable(sys_get_temp_dir()))
        {
            // use xdebug setting
            return Config::xdebugOutputDir();
        }
     ...
     */
    static function getBinaryPreprocessor(): string
    {
    ...
    static function compileBinaryPreprocessor(): bool
    {
        $make = '/usr/bin/make';
    ...
    static function compileBinaryPreprocessorWindows(): bool
    {
